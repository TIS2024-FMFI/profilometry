    ...
    def find_line_alg1(self, img):
        ...
        for col in range(width):
            ...
            if max(column_pixels) > self.significant_threshold_pixel:
                ...
                largest_points.append((np.int64(col), np.argmax(column_pixels)))
...
ln =LineDetection('images/gombik', 'images/gombik_alg', 1 , 'png')
ln.apply_to_folder()
print(ln.all_points2)
ln.display_all_points2()